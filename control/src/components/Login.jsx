    ...
    <>
      ...
      <div className={login.mainWrap}>
        ...
        You can create a SAS account if you don't have one already. You can reset your password if your account is locked. 
            <div >
                <a class="sas-link">Login</a> · 
                <a class="sas-link" >Logout</a> · 
                <a class="sas-link" >Reset password</a> ·
                <a class="sas-link" >Resend Activation Link</a>
            </div>  
        </div>
      </div>
      ...
      <footer>
            <div className={login.footerInfo}>
                ...
                <div class="footer__separation">·</div>
                <div class="main-footer footer__copy-right">© Talent.com</div>
            </div>
        </footer>
    </>
  );
